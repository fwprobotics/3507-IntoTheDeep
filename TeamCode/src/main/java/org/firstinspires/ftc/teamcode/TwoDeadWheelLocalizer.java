...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3352.6163126990386; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -2658.793568485841; // x position of the perpendicular encoder (in tick units)
    }
